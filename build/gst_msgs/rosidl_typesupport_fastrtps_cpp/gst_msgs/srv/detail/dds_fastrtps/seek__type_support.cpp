...
#include "gst_msgs/srv/detail/seek__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gst_msgs::srv::Seek_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gst_msgs::srv::Seek_Request & ros_message)
{
  // Member: seek_time
  cdr >> ros_message.seek_time;
...
{
  auto typed_message =
    static_cast<const gst_msgs::srv::Seek_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gst_msgs::srv::Seek_Request *>(
    untyped_ros_message);
...
static size_t _Seek_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Seek_Request(full_bounded, is_plain, 0);
...
{
  return &gst_msgs::srv::typesupport_fastrtps_cpp::_Seek_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gst_msgs, srv, Seek_Request)() {
  return &gst_msgs::srv::typesupport_fastrtps_cpp::_Seek_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_gst_msgs
cdr_serialize(
  const gst_msgs::srv::Seek_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gst_msgs::srv::Seek_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const gst_msgs::srv::Seek_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<gst_msgs::srv::Seek_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _Seek_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Seek_Response(full_bounded, is_plain, 0);
...
{
  return &gst_msgs::srv::typesupport_fastrtps_cpp::_Seek_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gst_msgs, srv, Seek_Response)() {
  return &gst_msgs::srv::typesupport_fastrtps_cpp::_Seek_Response__handle;
}
...
{
  return &gst_msgs::srv::typesupport_fastrtps_cpp::_Seek__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gst_msgs, srv, Seek)() {
  return &gst_msgs::srv::typesupport_fastrtps_cpp::_Seek__handle;
}
