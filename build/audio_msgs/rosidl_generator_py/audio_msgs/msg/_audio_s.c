...
bool audio_msgs__msg__audio__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("audio_msgs.msg._audio.Audio", full_classname_dest, 27) == 0);
  }
  audio_msgs__msg__Audio * ros_message = _ros_message;
  {  // header
  ...
  {  // frames
    ...
    assert(PyLong_Check(field));
    ros_message->frames = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // channels
  ...
  {  // sample_rate
    ...
    assert(PyLong_Check(field));
    ros_message->sample_rate = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // encoding
  ...
  {  // layout
    ...
    assert(PyLong_Check(field));
    ros_message->layout = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // step
...
{
  /* NOTE(esteve): Call constructor of Audio */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("audio_msgs.msg._audio");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Audio");
  ...
  {  // frames
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->frames);
    {
  ...
  {  // sample_rate
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->sample_rate);
    {
  ...
  {  // layout
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->layout);
    {
