...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v11.4.6"
  WORKING_DIRECTORY "/home/devuser/Workspaces/rosgsthumble_ws/src/build/webrtc_camera_node/_deps/ixwebsocket-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/devuser/Workspaces/rosgsthumble_ws/src/build/webrtc_camera_node/_deps/ixwebsocket-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/devuser/Workspaces/rosgsthumble_ws/src/build/webrtc_camera_node/_deps/ixwebsocket-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
