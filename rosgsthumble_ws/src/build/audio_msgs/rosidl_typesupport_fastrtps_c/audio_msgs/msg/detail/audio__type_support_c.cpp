...
#include "audio_msgs/msg/detail/audio__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_audio_msgs
...
using _Audio__ros_msg_type = audio_msgs__msg__Audio;
...
size_t get_serialized_size_audio_msgs__msg__Audio(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Audio__ros_msg_type * ros_message = static_cast<const _Audio__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Audio__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_audio_msgs__msg__Audio(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_audio_msgs
size_t max_serialized_size_audio_msgs__msg__Audio(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Audio__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_audio_msgs__msg__Audio(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, audio_msgs, msg, Audio)() {
