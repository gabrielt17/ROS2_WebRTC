...
static void on_offer_created(GstPromise *promise, gpointer user_data) {
    ...
    RCLCPP_INFO(rclcpp::get_logger("camera_webrtc_node"), ">>> OFERTA GERADA:\n%s", sdp_offer.dump().c_str());
...
static void on_negotiation_needed(GstElement* element, gpointer user_data) {
    RCLCPP_INFO(rclcpp::get_logger("camera_webrtc_node"), "Pipeline iniciada, aguardando frames...");
...
static void on_ice_candidate(GstElement *webrtc, guint mline_index, gchar *candidate) {
    ...
    RCLCPP_INFO(rclcpp::get_logger("camera_webrtc_node"), ">>> CANDIDATO ICE GERADO:\n%s", ice_candidate.dump().c_str());
}
...
int main(int argc, char* argv[]) {
    ...
    auto node = rclcpp::Node::make_shared("camera_webrtc_node");
