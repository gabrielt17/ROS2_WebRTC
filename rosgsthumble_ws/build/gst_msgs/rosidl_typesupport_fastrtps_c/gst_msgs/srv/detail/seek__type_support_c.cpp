...
#include "gst_msgs/srv/detail/seek__rosidl_typesupport_fastrtps_c.h"
...
using _Seek_Request__ros_msg_type = gst_msgs__srv__Seek_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: seek_time
  {
    cdr << ros_message->seek_time;
  }
...
size_t get_serialized_size_gst_msgs__srv__Seek_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name seek_time
  {
    size_t item_size = sizeof(ros_message->seek_time);
...
static uint32_t _Seek_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gst_msgs__srv__Seek_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gst_msgs
size_t max_serialized_size_gst_msgs__srv__Seek_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gst_msgs__srv__Seek_Request;
    is_plain =
      (
...
static size_t _Seek_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gst_msgs__srv__Seek_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gst_msgs, srv, Seek_Request)() {
...
using _Seek_Response__ros_msg_type = gst_msgs__srv__Seek_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gst_msgs
size_t get_serialized_size_gst_msgs__srv__Seek_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Seek_Response__ros_msg_type * ros_message = static_cast<const _Seek_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_gst_msgs__srv__Seek_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gst_msgs
size_t max_serialized_size_gst_msgs__srv__Seek_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = gst_msgs__srv__Seek_Response;
    is_plain =
      (
...
static size_t _Seek_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gst_msgs__srv__Seek_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gst_msgs, srv, Seek_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gst_msgs, srv, Seek)() {
  return &Seek__handle;
}
