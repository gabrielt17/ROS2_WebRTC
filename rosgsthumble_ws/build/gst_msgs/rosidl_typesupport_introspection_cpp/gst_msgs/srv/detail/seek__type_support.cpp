...
{
  new (message_memory) gst_msgs::srv::Seek_Request(_init);
}

void Seek_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gst_msgs::srv::Seek_Request *>(message_memory);
  typed_message->~Seek_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Seek_Request_message_member_array[2] = {
  {
    "seek_time",  // name
    ...
    offsetof(gst_msgs::srv::Seek_Request, seek_time),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gst_msgs::srv::Seek_Request, flags),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Seek_Request_message_members = {
  "gst_msgs::srv",  // message namespace
  "Seek_Request",  // message name
  2,  // number of fields
  sizeof(gst_msgs::srv::Seek_Request),
...
{
  return &::gst_msgs::srv::rosidl_typesupport_introspection_cpp::Seek_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gst_msgs, srv, Seek_Request)() {
  return &::gst_msgs::srv::rosidl_typesupport_introspection_cpp::Seek_Request_message_type_support_handle;
}
...
void Seek_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) gst_msgs::srv::Seek_Response(_init);
}

void Seek_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gst_msgs::srv::Seek_Response *>(message_memory);
  typed_message->~Seek_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Seek_Response_message_member_array[2] = {
  {
    "success",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gst_msgs::srv::Seek_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gst_msgs::srv::Seek_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Seek_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(gst_msgs::srv::Seek_Response),
...
{
  return &::gst_msgs::srv::rosidl_typesupport_introspection_cpp::Seek_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gst_msgs, srv, Seek_Response)() {
  return &::gst_msgs::srv::rosidl_typesupport_introspection_cpp::Seek_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Seek_service_members = {
  "gst_msgs::srv",  // service namespace
  "Seek",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<gst_msgs::srv::Seek>()
...
get_service_type_support_handle<gst_msgs::srv::Seek>()
{
  ...
  auto service_type_support =
    &::gst_msgs::srv::rosidl_typesupport_introspection_cpp::Seek_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gst_msgs, srv, Seek)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<gst_msgs::srv::Seek>();
}
