...
static const _FrameGate_type_support_symbol_names_t _FrameGate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gst_msgs, msg, FrameGate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gst_msgs, msg, FrameGate)),
  }
};
...
{
  return &::gst_msgs::msg::rosidl_typesupport_cpp::FrameGate_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gst_msgs, msg, FrameGate)() {
  return get_message_type_support_handle<gst_msgs::msg::FrameGate>();
}
