...
#define NODE_MAIN_LOGGER_NAME "gst_pipeline_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgst_pipeline.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<gst_pipeline::gst_pipeline>";
